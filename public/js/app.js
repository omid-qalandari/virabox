    ...
    return {
        init: function init(t) {
            ...
            for (var e = 1; e < arguments.length; e++) {
                var a = arguments[e];
                if (a) for (var n in a) {
                    a.hasOwnProperty(n) && ("object" == _typeof(a[n]) ? t[n] = mUtil.deepExtend(t[n], a[n]) : t[n] = a[n]);
                }
            }
            return t;
            ...
            if (t && void 0 !== e) {
                ...
                } else if (!mUtil.hasClass(t, e)) for (n = 0; n < a.length; n++) {
        ...
        }, slide: function slide(t, e, a, n, o) {
        ...
        }, scrollerInit: function scrollerInit(t, e) {
            function a() {
                var a, n;
        ...
        }, scrollerUpdate: function scrollerUpdate(t) {
            var e;
            (e = mUtil.data(t).get("ps")) && e.update();
        }, scrollersUpdate: function scrollersUpdate(t) {
            for (var e = mUtil.findAll(t, ".ps"), a = 0, n = e.length; a < n; a++) {
                mUtil.scrollerUpdate(e[a]);
            }
        }, scrollerTop: function scrollerTop(t) {
            mUtil.data(t).get("ps") && (t.scrollTop = 0);
        }, scrollerDestroy: function scrollerDestroy(t) {
            var e;
...
var mApp = function () {
    ...
    return {
        init: function init(e) {
            ...
            jQuery.event.special.touchstart = {
                ...
                mUtil.scrollerInit(this, {
                    disableForMobile: !0, handleWindowResize: !0, height: function height() {
            ...
            n(t);
        }, initPortlet: function initPortlet(t, e) {
            i(t, e);
        ...
        }, unprogress: function unprogress(t) {
...
$(document).ready(function () {
    ...
    t.fn.mDatatable = function (n) {
        if (0 !== t(this).length) {
            ...
            var i = {
                isInit: !1, offset: 110, stateId: "meta", ajaxParams: {}, init: function init(e) {
                    var a = !1;
                    ...
                    }), "remote" !== e.data.type && "local" !== e.data.type || ((!1 === e.data.saveState || !1 === e.data.saveState.cookie && !1 === e.data.saveState.webstorage) && i.stateRemove(i.stateId), "local" === e.data.type && "object" == _typeof(e.data.source) && (o.dataSet = o.originalDataSet = i.dataMapCallback(e.data.source)), i.dataRender()), a || (i.setHeadTitle(), i.getOption("layout.footer") && i.setHeadTitle(o.tableFoot)), void 0 !== e.layout.header && !1 === e.layout.header && t(o.table).find("thead").remove(), void 0 !== e.layout.footer && !1 === e.layout.footer && t(o.table).find("tfoot").remove(), null !== e.data.type && "local" !== e.data.type || (i.setupCellField.call(), i.setupTemplateCell.call(), i.setupSubDatatable.call(), i.setupSystemColumn.call(), i.redraw()), t(window).resize(i.fullRender), t(o).height(""), t(i.getOption("search.input")).on("keyup", function (e) {
                    ...
                    var e = {
                        lockEnabled: !1, init: function init() {
                    ...
                    if (o.dataSet = o.dataSet || [], 0 !== o.dataSet.length) {
                        ...
                        var a = function a(_a) {
                            ...
                            if (void 0 !== n && void 0 !== n.selector && !1 !== n.selector) {
                                var o = t(_a).find('[data-field="' + n.field + '"]');
                    ...
                    var a = {
                        ...
                        initDefaultScrollbar: function initDefaultScrollbar(e) {
                    ...
                    if ("function" == typeof e && !(t(o.table).find(".m-datatable__subtable").length > 0)) {
                        ...
                        var a = function a(_a2) {
                            ...
                            t(l).hasClass("m-datatable__row--subtable-expanded") ? (t(c).addClass(i.getOption("layout.icons.rowDetail.collapse")), t(l).removeClass("m-datatable__row--subtable-expanded"), t(o).trigger("m-datatable--on-collapse-subtable", [l])) : (t(c).addClass(i.getOption("layout.icons.rowDetail.expand")), t(l).addClass("m-datatable__row--subtable-expanded"), t(o).trigger("m-datatable--on-expand-subtable", [l])), 0 === t(s).find(".m-datatable").length && (t.map(o.dataSet, function (t, e) {
                                return d === t[n.columns[0].field] && (_a2.data = t, !0);
                            }), _a2.detailCell = s, _a2.parentRow = l, _a2.subTable = s, e(_a2), t(s).children(".m-datatable").on("m-datatable--on-init", function (e) {
                ...
                }, isSpinning: !1, spinnerCallback: function spinnerCallback(t) {
                    if (t) {
                        if (!i.isSpinning) {
                    ...
                    var e = {
                        ...
                        }, sortClick: function sortClick(a) {
                    ...
                    if (void 0 !== l && !0 !== i.getOption("data.serverSorting") ? "function" == typeof l.sortCallback ? o.dataSet = l.sortCallback(o.originalDataSet, n, l) : o.dataSet = i.sortCallback(o.originalDataSet, n, l) : o.dataSet = o.originalDataSet, "object" == _typeof(e.query) && !i.getOption("data.serverFiltering")) {
                        e.query = e.query || {};
                        var r = function r(t) {
                            for (var e in t) {
                                if (t.hasOwnProperty(e)) if ("string" == typeof t[e]) {
                                    ...
                                    if (t[e] === s) return !0;
                                } else if ("object" == _typeof(t[e])) return r(t[e]);
                            }return !1;
                        },
                    ...
                    if (void 0 === n && (n = "AND"), "object" != (typeof a === "undefined" ? "undefined" : _typeof(a))) return e;
                    ...
                    return function t(e) {
                        var i = n[o++];
                        void 0 !== e[i] && null !== e[i] ? "object" != _typeof(e[i]) && "function" != typeof e[i] && (e[i] = {}) : e[i] = {}, o === n.length ? e[i] = a : t(e[i]);
                    }(t), t;
                    ...
                    void 0 !== a && (a = t.makeArray(a)), o = function o() {
                        var o = i.getDataSourceQuery();
                        if (void 0 === a && void 0 !== e) {
                            var l = i.getGeneralSearchKey();
                            o[l] = e;
                        }
                        "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && (t.each(a, function (t, a) {
                            o[a] = e;
        ...
        rows: {
            callback: function callback() {}, beforeTemplate: function beforeTemplate() {}, afterTemplate: function afterTemplate() {}, autoHide: !1
        },
        toolbar: {
...
var mDropdown = function mDropdown(t, e) {
    var a = this,
        n = mUtil.get(t),
        o = mUtil.get("body");
    if (n) {
        var i = {
            ...
            }, hideHovered: function hideHovered(t) {
                if (!0 === t) {
...
var mHeader = function mHeader(t, e) {
    var a = this,
        n = mUtil.get(t),
        o = mUtil.get("body");
    if (void 0 !== n) {
        ...
        var l = {
            ...
            construct: function construct(t) {
                ...
                if ("accordion" !== r.getSubmenuMode(e)) {
                    ...
                    if (a.length > 0 && !1 === mUtil.hasClass(e, "m-menu__toggle") && 0 === e.querySelectorAll(".m-menu__toggle").length) for (var n = 0, i = a.length; n < i; n++) {
                ...
                var e,
                    a = (e = mUtil.child(t, ".m-menu__submenu") ? mUtil.css(e, "z-index") : 0) - 1,
            ...
            }, adjustSubmenuDropdownArrowPos: function adjustSubmenuDropdownArrowPos(t) {
                ...
                if (!1 === a.options.accordion.expandAll && (e = o.querySelectorAll(".m-menu__item--open"))) for (i = 0, l = e.length; i < l; i++) {
...
document.addEventListener("click", function (t) {
    ...
    if (e = mUtil.get("body").querySelectorAll('.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]')) for (var a = 0, n = e.length; a < n; a++) {
        ...
        if (o) {
            ...
            if (t.target !== o && !1 === o.contains(t.target)) if (i = o.querySelectorAll('.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]')) for (var r = 0, s = i.length; r < s; r++) {
                l.hideDropdown(i[r]);
            }
        }
    }
});
var mOffcanvas = function mOffcanvas(t, e) {
    var a = this,
        n = mUtil.get(t),
        o = mUtil.get("body");
    if (n) {
        var i = {},
            ...
            construct: function construct(t) {
                ...
                if (a.options.toggleBy) if ("string" == typeof a.options.toggleBy) mUtil.addEvent(a.options.toggleBy, "click", l.toggle);else if (a.options.toggleBy && a.options.toggleBy[0] && a.options.toggleBy[0].target) for (var t in a.options.toggleBy) {
            ...
            }, togglerClass: function togglerClass(t, e) {
                var n,
                    o = mUtil.attr(t, "id");
    ...
    mPortlet = function mPortlet(t, e) {
    var a = this,
        n = mUtil.get(t),
        o = mUtil.get("body");
    if (n) {
    ...
    mQuicksearch = function mQuicksearch(t, e) {
    var a = this,
        n = mUtil.get(t),
        o = mUtil.get("body");
    if (n) {
        var l = {
            ...
            construct: function construct(t) {
            ...
            }, handleCancelIconVisibility: function handleCancelIconVisibility(t) {
            ...
            }, handleCancel: function handleCancel(t) {
                ...
                a.dropdown.hide();
            }, showDropdown: function showDropdown(t) {
    ...
    mScrollTop = function mScrollTop(t, e) {
    var a = this,
        n = mUtil.get(t),
        o = mUtil.get("body");
    if (n) {
...
!function (t) {
    t.fn.mDatatable = t.fn.mDatatable || {}, t.fn.mDatatable.checkbox = function (e, a) {
        var n = {
            selectedAllRows: !1, selectedRows: [], unselectedRows: [], init: function init() {
        ...
        return e.checkbox = function () {
            return n;
        }, "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && (a = t.extend(!0, {}, t.fn.mDatatable.checkbox.default, a), n.init.apply(this, [a])), e;
...
var mLayout = function () {
    var t,
        ...
        i,
        _l = function l() {
        0 !== $("#m_aside_left_hide_toggle").length && (_l = new mToggle("m_aside_left_hide_toggle", {
            target: "body",
    ...
    return {
        init: function init() {
            ...
            })), _l(), this.onLeftSidebarToggle(function (t) {
                i && i.updateSticky();
                var e = $(".m-datatable");
                e && e.each(function () {
            ...
            return e;
        }, onLeftSidebarToggle: function onLeftSidebarToggle(t) {
            o && o.on("toggle", t);
        ...
        init: function init() {
            ...
            !function () {
                ...
                columns: [{
                    ...
                    field: "Status", title: "Status", width: 100, template: function template(e) {
                        var t = {
                    ...
                    field: "Type", title: "Type", width: 100, template: function template(e) {
                        var t = {
